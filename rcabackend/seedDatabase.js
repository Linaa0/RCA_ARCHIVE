...
async function seedDatabase() {
  try {
    ...
    const students = [
      {
        email: "alice@student.rca.ac.uk",
        password: "student123",
        name: "Alice Johnson",
      },
      {
        email: "bob@student.rca.ac.uk",
        password: "student123",
        name: "Bob Smith",
      },
      {
        email: "charlie@student.rca.ac.uk",
        password: "student123",
        name: "Charlie Davis",
      },
    ];
    ...
    const teachers = [
      {
        email: "prof.smith@rca.ac.uk",
        password: "teacher123",
        name: "Prof. Smith",
      },
      {
        email: "teacher@rca.ac.uk",
        password: "teacher123",
        name: "Teacher Admin",
      },
    ];
    ...
    for (const student of students) {
      ...
      if (!exists) {
        ...
        console.log(`⏭️  Student exists: ${student.email}`);
      }
    }
